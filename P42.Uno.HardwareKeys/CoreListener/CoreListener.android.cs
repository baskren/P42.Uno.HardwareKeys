...
internal partial class CoreListener : Button
{
    ...
    public override bool OnKeyUp([GeneratedEnum] Keycode keyCode, KeyEvent e)
    {
        ...
        if (IsNumLockEngaged == KeyState.False)
        {
            switch (keyCode)
            {
                case Keycode.Numpad0: key = VirtualKey.Insert; text = String.Empty; break;
                case Keycode.NumpadDot: key = VirtualKey.Delete; text = String.Empty; break;
                case Keycode.Numpad1: key = VirtualKey.End; text = String.Empty; break;
                case Keycode.Numpad2: key = VirtualKey.Down; text = String.Empty; break;
                case Keycode.Numpad3: key = VirtualKey.PageDown; text = String.Empty; break;
                case Keycode.Numpad4: key = VirtualKey.Left; text = String.Empty; break;
                case Keycode.Numpad5: key = VirtualKey.Clear; text = String.Empty; break;
                case Keycode.Numpad6: key = VirtualKey.Right; text = String.Empty; break;
                case Keycode.Numpad7: key = VirtualKey.Home; text = String.Empty; break;
                case Keycode.Numpad8: key = VirtualKey.Up; text = String.Empty; break;
                case Keycode.Numpad9: key = VirtualKey.PageUp; text = String.Empty; break;
            }
        }
