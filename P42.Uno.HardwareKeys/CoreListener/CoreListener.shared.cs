...
#pragma warning restore CS0067
    ...
    async Task MoveFocusToEditable()
    {
        try
        {
            if (FocusManager.FindNextElement(FocusNavigationDirection.Next, new FindNextElementOptions
            { }) is Control control &&
...
#else
    static readonly HashSet<VirtualKey> knownKeys = Enum.GetValues<VirtualKey>().ToHashSet();
#endif
