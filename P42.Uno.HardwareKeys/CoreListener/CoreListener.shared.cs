...
[Bindable]
internal partial class CoreListener
{
    #region Properties

    #region Modifier Keys

    private KeyState _isControlPressed;
    ...
    private KeyState _isShiftPressed;
    ...
    private KeyState _isWindowsPressed;
    ...
    private KeyState _isMenuPressed;
    ...
    private KeyState _numLockEngaged = KeyState.Unknown;
    ...
    private KeyState _capsLockEngaged;
    ...
    private bool _focusManually = true;
    ...
    private VirtualKey[] CurrentModifiers
    {
        get
        {
    ...
    private Control _platformCoreElement;
    private Control _lastFocusedControl;
    private Control _tryingToFocusControl;
    #endregion
...
#pragma warning restore CS0067
    ...
    private async Task<FocusMovementResult> TryFocusAsync(Control control, FocusState state)
    {
    ...
    private async Task MoveFocusToEditable()
    {
        try
        {
    ...
    private LosingFocusEventArgs losingFocusEventArgs;
    ...
    private bool ProcessModifier(VirtualKey key, bool down)
    {
    ...
    private static readonly VirtualKey[] _charKeyBoundaries =
    [
        VirtualKey.None,
        VirtualKey.Help,
        VirtualKey.Z,
    ...
    private bool IsNumpadNumKey(VirtualKey key)
    {
    ...
    private bool IsCharacterKey(VirtualKey key)
    {
        if (IsNumpadNumKey(key))
            //Microsoft.UI.Xaml.Window.Current is often null!
    ...
    private KeyState WinUIKeyEngaged(VirtualKey key1, VirtualKey key2, Windows.UI.Core.CoreVirtualKeyStates state)
...
#else
    private static readonly HashSet<VirtualKey> knownKeys = Enum.GetValues(typeof(VirtualKey)).Cast<VirtualKey>().ToHashSet();
#endif


    private bool IsInGroup(VirtualKey key, VirtualKey[] boundaries, bool firstGroupState)
    {
